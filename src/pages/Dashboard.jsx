    ...
    <div className="min-h-screen bg-gray-100">
      ...
      >
        ...
        <nav className="px-4 py-6">
          <Link
            to="/dashboard"
            className="flex items-center space-x-2 px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg"
          >
            <FaChartLine />
            <span>Dashboard</span>
          </Link>
          <Link
            to="/dashboard/create"
            className="flex items-center space-x-2 px-4 py-2 text-gray-700 hover:bg-blue-50 rounded-lg mt-2"
          >
            <FaPlus />
            <span>Create Ad</span>
          </Link>
